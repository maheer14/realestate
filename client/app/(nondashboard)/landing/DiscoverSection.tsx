        ...
        <motion.div
          ...
          >
            ...
            <p className='mt-2 text-gray-500 max-w-3xl mx-auto'>
                We're making searching for your dream rental property easier than ever before. Our UI
                search feature quickly finds the perfect home for you! 
            </p>
        </motion.div>
          ...
          {[
            {
                ...
                description: "Browser through our extensive collection of rental properties in your desired location."
            }, 
            {
